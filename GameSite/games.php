...
<html>
    ...
    <body>
        <div id="navigation">
            ...
            <div id = 'CTA'>
                <p>Damn you're putting us in a tough spot here man you cant keep catching us like this!</p>
            </div> 
        </div>
        <div id="sections">
            <div id="about">
                ...
                <p class="aboutText">this project was made by 4 members for the assessment 
                    of the Web Programming subject, this is supposed to be the games page so we can bother you :3
                </p>
            </div>
            <div id="contact">
                <h4>CONTACT US</h4>
